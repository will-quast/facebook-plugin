...
@synthesize invokeString, window, viewController, facebook;
...
{    
    ...
    if (url && [url isKindOfClass:[NSURL class]]) {
		...
		NSLog(@"FacebookPlugin launchOptions = %@", url);
    }    
    ...
    facebook = [[Facebook alloc] initWithAppId:@"263149720445234" andDelegate:self];
